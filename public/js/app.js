...
/* harmony import */ var _controllers_importer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./controllers/importer */ "./resources/js/controllers/importer.js");
...
document.addEventListener("turbo:load", function (event) {
  if (window.location.href.indexOf('importar-dados?processing') > -1) {
    ...
    if ('customers' === type) {
      fetchCustomers().then(function (data) {
        if (data.success) {
    ...
    if ('orders' === type) {
      fetchOrders().then(function (data) {
        console.log(data);
        loadingElem.style.display = "none";
      });
    }
...
function _fetchCustomers() {
  _fetchCustomers = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response, json;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch('http://' + window.location.host + '/asyncRunImportCustomers');
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return fetch('http://' + window.location.host + '/asyncRunImportOrders');
...
/***/ "./resources/js/controllers/importer.js":
/*!**********************************************!*\
  !*** ./resources/js/controllers/importer.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
